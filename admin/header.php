...
<html lang="en">
    <head>
		...
		<link rel="stylesheet"href="assets/css/bs_leftnavi.css">
		<script src="assets/js/bs_leftnavi.js"></script>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <title>Panel OTT</title>
    ...
    <div class="nano-content">
      <ul class="gw-nav gw-nav-list">
        <li class="init-un-active"> <a href="javascript:void(0)"> <span class="gw-menu-text"><a href="./dashboard.php">Inicio</a></span> </a> </li>
        <li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Servidores</span> <b class="gw-arrow"></b> </a>
          <ul class="gw-submenu">
        ...
        <li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Clientes</span> <b class="gw-arrow icon-arrow-up8"></b> </a>
          <ul class="gw-submenu">
        ...
        <li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Usuarios</span> <b></b> </a>
          <ul class="gw-submenu">
		<li><a href="./reg_user.php"><?=$_["add_registered_user"]?></a></li>
		<li><a href="./reg_users.php"><?=$_["manage_registered_users"]?></a></li>
          </ul>
        </li>
		<li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Paquetes</span> <b></b> </a>
          <ul class="gw-submenu">
		...
		<li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Televisión</span> <b></b> </a>
          <ul class="gw-submenu">
		...
		<li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Peliculas</span> <b></b> </a>
          <ul class="gw-submenu">
		...
		<li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Series</span> <b></b> </a>
          <ul class="gw-submenu">
		...
		<li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Radios</span> <b></b> </a>
          <ul class="gw-submenu">
		...
		<li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Dispositivos</span> <b></b> </a>
          <ul class="gw-submenu">
		...
		<li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Registros</span> <b></b> </a>
          <ul class="gw-submenu">
		...
		<li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Tickets</span> <b></b> </a>
          <ul class="gw-submenu">
		<li><a href="./tickets.php"> <i class="la la-envelope"></i><?=$_["tickets"]?></a></li>
          </ul>
        </li>
		<li class="init-arrow-down"> <a href="javascript:void(0)"> <span class="gw-menu-text">Info</span> <b></b> </a>
          <ul class="gw-submenu">
		<li><a href="https://noky.cl">NokyTV V1.01 REV3</a></li>
          </ul>
        </li>
      </ul>
    </div>
                ...
                <div class="container-fluid">
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            <li>
                                <a href="./<?php if ($rPermissions["is_admin"]) { ?>dashboard.php<?php } else { ?>reseller.php<?php } ?>"><i class="la la-dashboard"></i><?=$_["dashboard"]?></a>
                            </li>
                            <?php if (($rPermissions["is_reseller"]) && ($rPermissions["reseller_client_connection_logs"])) { ?>
                            <li class="has-submenu">
                                <a href="#"><i class="la la-exchange"></i><?=$_["connections"]?> <div class="arrow-down"></div></a>
                                <ul class="submenu">
                                    <li><a href="./live_connections.php"><?=$_["live_connections"]?></a></li>
                                    <li><a href="./user_activity.php"><?=$_["activity_logs"]?></a></li>
                                </ul>
                            ...
                            <li class="has-submenu">
                                <a href="#"><i class="la la-server"></i><?=$_["servers"]?> <div class="arrow-down"></div></a>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu">
                                <a href="#"> <i class="la la-users"></i><?=$_["subresellers"]?> <div class="arrow-down"></div></a>
                                <ul class="submenu">
                                    <?php if ($rPermissions["is_admin"]) { ?>
                            ...
                            <li class="has-submenu">
                                <a href="#"> <i class="la la-video-camera"></i><?=$_["vod"]?> <div class="arrow-down"></div></a>
                            ...
                            <li class="has-submenu">
                                <a href="#"> <i class="mdi mdi-flower-tulip-outline"></i><?=$_["bouquets"]?> <div class="arrow-down"></div></a>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu">
                                <a href="#"> <i class="la la-play-circle-o"></i><?=$_["content"]?> <div class="arrow-down"></div></a>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu">
                                <a href="#"> <i class="la la-envelope"></i><?=$_["support"]?> <div class="arrow-down"></div></a>
                                <ul class="submenu">
                            ...
                            <li>
                                <a href="./tickets.php"> <i class="la la-envelope"></i><?=$_["tickets"]?></a>
                            </li>
                            <?php } ?>
                        </ul>
                        <!-- End navigation menu -->
