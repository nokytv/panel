                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <a href="./servers.php"><li class="breadcrumb-item"><i class="mdi mdi-backspace"></i> Volver a los servidores</li></a>
                                </ol>
                            </div>
                            <h4 class="page-title"><?php if (isset($rServerArr)) { echo "Editar"; } else { echo "Añadir"; } ?> Servidor</h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            La operación del servidor se completó con éxito.
                        </div>
                                        ...
                                        <div class="tab-content b-0 mb-0 pt-0">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="server_name">Nombre del servidor</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="domain_name">Nombre de dominio</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="server_ip">IP del Servidor</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="total_clients">clientes maximos</label>
                                                            <div class="col-md-2">
                                                            ...
                                                            <label class="col-md-4 col-form-label" for="timeshift_only">Solo Timeshift</label>
                                                            <div class="col-md-2">
                                            ...
                                            <div class="tab-pane" id="advanced-options">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="http_broadcast_port">Puerto HTTP</label>
                                                            <div class="col-md-2">
                                                            ...
                                                            <label class="col-md-4 col-form-label" for="https_broadcast_port">Puerto HTTPS</label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="rtmp_port">Puerto RTMP</label>
                                                            <div class="col-md-2">
                                                            ...
                                                            <label class="col-md-4 col-form-label" for="diff_time_main">Diferencia horaria - Segundos</label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="network_interface">Interfaz de red</label>
                                                            <div class="col-md-2">
                                                            ...
                                                            <label class="col-md-4 col-form-label" for="network_guaranteed_speed">Velocidad de red: Mbps</label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="system_os">Sistema operativo</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="enable_geoip">Balanceo de carga GeoIP</label>
                                                            <div class="col-md-2">
                                                            ...
                                                            <div class="col-md-6">
                                                                <select name="geoip_type" id="geoip_type" class="form-control select2" data-toggle="select2">
                                                                    <?php foreach (Array("high_priority" => "Alta prioridad", "low_priority" => "Baja prioridad", "strict" => "Estricto") as $rType => $rText) { ?>
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="geoip_countries">Países GeoIP</label>
                                                            <div class="col-md-8">
                                                ...
                                                <ul class="list-inline wizard mb-0">
                                                    ...
                                                    <li class="next list-inline-item float-right">
                                                        <input name="submit_server" type="submit" class="btn btn-primary" value="<?php if (isset($rServerArr)) { echo "Editar"; } else { echo "Añadir"; } ?>" />
                                                    </li>
                                                </ul>
                                            </div>
                                        </div> <!-- tab-content -->
