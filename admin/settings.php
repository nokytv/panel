                                        ...
                                        <ul class="nav nav-pills bg-light nav-justified form-wizard-header mb-4">
											...
											<li class="nav-item">
                                                <a href="#xui" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2"> 
                                                    ...
                                                    <span class="d-none d-sm-inline">Sistema</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
