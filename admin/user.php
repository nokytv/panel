                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <a href="./users.php<?php if (isset($_GET["mag"])) { echo "?mag"; } else if (isset($_GET["e2"])) { echo "?e2"; } ?>"><li class="breadcrumb-item"><i class="mdi mdi-backspace"></i>Volver a usuarios</li></a>
                                </ol>
                            </div>
                            <h4 class="page-title"><?php if (isset($rUser)) { echo "Editar"; } else { echo "Añadir"; } ?> Cliente</h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            La operación del usuario se completó con éxito.
                        </div>
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            ...
                            Se ingresó una fecha de vencimiento incorrecta, por favor intente nuevamente.
                        </div>
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            ...
                            ¡Hubo un error al realizar esta operación! Verifique la entrada del formulario e intente nuevamente.
                        </div>
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            ...
                            Este nombre de usuario ya existe. Por favor intente con otro.
                        </div>
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            ...
                            Se ingresó una dirección MAC no válida, por favor intente nuevamente.
                        </div>
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            ...
                            Esta dirección MAC ya está en uso. Por favor use otro.
                        </div>
                        <?php } 
                        } ?>
                        <div class="card">
                                        ...
                                        <ul class="nav nav-pills bg-light nav-justified form-wizard-header mb-4">
                                            ...
                                            <li class="nav-item">
                                                <a href="#restrictions" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                                    ...
                                                    <span class="d-none d-sm-inline">Restricciones</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                        ...
                                        <div class="tab-content b-0 mb-0 pt-0">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="username">Nombre de usuario</label>
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control" id="username" name="username" placeholder="autogenerar si está en blanco" value="<?php if (isset($rUser)) { echo htmlspecialchars($rUser["username"]); } ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="password">Contraseña</label>
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control" id="password" name="password" placeholder="autogenerar si está en blanco" value="<?php if (isset($rUser)) { echo htmlspecialchars($rUser["password"]); } ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="member_id">Usuario</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="max_connections">Pantallas</label>
                                                            <div class="col-md-2">
                                                            ...
                                                            <label class="col-md-2 col-form-label" for="exp_date">Vence<i data-toggle="tooltip" data-placement="top" title="" data-original-title="Dejar en blanco para ilimitado." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="admin_notes">Notas de administrador</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="reseller_notes">Notas del revendedor</label>
                                                            <div class="col-md-8">
                                            ...
                                            <div class="tab-pane" id="advanced-options">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="force_server_id">Conexión forzada <i data-toggle="tooltip" data-placement="top" title="" data-original-title="Force this user to connect to a specific server. Otherwise, the server with the lowest load will be selected." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-8">
                                                                <select name="force_server_id" id="force_server_id" class="form-control select2" data-toggle="select2">
                                                                    <option <?php if (isset($rUser)) { if (intval($rUser["force_server_id"]) == 0) { echo "selected "; } } ?>value="0">Desabilitado</option>
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="is_stalker">Portal Ministra<i data-toggle="tooltip" data-placement="top" title="" data-original-title="Select this option if you intend to use this account with your Ministra / Stalker portal. Output formats, expiration and connections below will be ignored. Only MPEG-TS output is allowed." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="is_e2">Dispositivo Enigma <i data-toggle="tooltip" data-placement="top" title="" data-original-title="This option will be selected if this device is a Enigma set top box. This will be a sub account and should not be modified directly." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
                                                            ...
                                                            <label class="col-md-4 col-form-label" for="is_mag">Dispositivo MAG <i data-toggle="tooltip" data-placement="top" title="" data-original-title="This option will be selected if this device is a MAG set top box. This will be a sub account and should not be modified directly." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="is_trial">Cuenta demo</label>
                                                            <div class="col-md-2">
                                                            ...
                                                            <label class="col-md-4 col-form-label" for="lock_device">MAG STB Bloquear</label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row mb-4" style="display:none" id="mac_entry_mag">
                                                            <label class="col-md-4 col-form-label" for="mac_address_mag">Dirección MAC</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row mb-4" style="display:none" id="mac_entry_e2">
                                                            <label class="col-md-4 col-form-label" for="mac_address_e2">Dirección MAC</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="forced_country">País forzado <i data-toggle="tooltip" data-placement="top" title="" data-original-title="Force user to connect to loadbalancer associated with the selected country." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="access_output">Salida de acceso</label>
                                                            <div class="col-md-8">
                                            ...
                                            <div class="tab-pane" id="restrictions">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="ip_field">Direcciones IP permitidas</label>
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="ua_field">Agentes de usuario permitidos</label>
                                                            <div class="col-md-8 input-group">
                                            ...
                                            <div class="tab-pane" id="bouquets">
                                                ...
                                                <ul class="list-inline wizard mb-0">
                                                    ...
                                                    <li class="list-inline-item float-right">
                                                        <a href="javascript: void(0);" onClick="toggleBouquets()" class="btn btn-info">Quitar todos</a>
                                                        <input name="submit_user" type="submit" class="btn btn-primary" value="<?php if (isset($rUser)) { echo "Editar"; } else { echo "Añadir"; } ?>" />
                                                    </li>
                                                </ul>
                                            </div>
                                        </div> <!-- tab-content -->
